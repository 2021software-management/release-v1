...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, s = layui.view, l = layui.device(),
        o = a(window), r = a("body"), d = a("#" + n.container), u = "layui-show", c = "layui-hide", y = "layui-this",
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", P = "LAY-system-side-menu", A = {
            v: "1.0.0-beta9 std", req: s.req, sendAuthCode: function (e) {
                    ...
                    if (t === e.seconds && !a(this).hasClass(f)) {
                        ...
                        A.req(a.extend(!0, {
                            url: "/auth/code", type: "get", data: {phone: n}, success: function (a) {
                                layer.msg("验证码已发送至你的手机，请注意查收", {icon: 1, shade: 0}), e.elemVercode.focus(), s(), l && l(a)
                            }
                        }, e.ajax))
                    }
                })
                ...
                var i = d, t = a("#" + h), s = A.screen();
                "spread" === e ? (t.removeClass(x).addClass(g), s < 2 ? i.addClass(v) : i.removeClass(v), i.removeClass(C)) : (t.removeClass(g).addClass(x), s < 2 ? i.removeClass(C) : i.addClass(C), i.removeClass(v)), layui.event.call(this, n.MOD_NAME, "side({*})", {status: e})
            }, on: function (e, a) {
            ...
            flexible: function (e) {
                ...
                var a = A.screen() < 2, i = layui.data(n.tableName).note;
                ...
                e.hasClass(y) || (e.addClass(y).siblings(".layui-this").removeClass(y), a.color[i] && (a.color[i].index = i, A.theme({color: a.color[i]})))
    ...
    !function () {
        ...
        }, n = a("#" + P), s = "layui-nav-itemed", l = function (e) {
            e.each(function (e, n) {
    ...
    var k = function (e) {
        var a = e.attr("lay-id"), i = e.attr("lay-attr"), t = e.index();
